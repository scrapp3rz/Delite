    ...
    <?php include("entete.php"); ?>
     ...
     <!-- Ininialisation de la page plat 
==================================================================================
==================================================================================
...
<div class="div-couleur2 col-md-offset-2 col-md-8 col-xs-offset-1 col-xs-10" >  <a href="pageRecette.php?id_recette=<?php echo $donnees['recipeid']?> ">
